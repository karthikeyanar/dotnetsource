...
!function($) {
		...
		var DRPTemplate='<div class="daterangepicker dropdown-menu">'+
                ...
                '<div class="ranges">'+
                  '<div class="range_inputs">'+
                    ...
                    '</div>'+
                    '<button class="'+this.applyClass+' applyBtn margin-right-10" disabled="disabled">'+this.locale.applyLabel+'</button>&nbsp;'+
	...
	DateRangePicker.prototype={
		...
		move: function() {
			var parentOffset={
				top: 0, // this.parentEl.offset().top-(this.parentEl.is('body')?0:this.parentEl.scrollTop()),
